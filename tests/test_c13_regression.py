...
published values from Connes (2026) and CCM (2025) up to expected
differences from N, precision, and normalization conventions (all
three computations use the same trigonometric basis).
